                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('store.profile') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img class="rounded-circle avatar-xl" id="showImage" src="{{ (!empty($editData->profile_image))? url('upload/admin_images/'.$editData->profile_image):url('upload/no_image.jpg') }}" alt="Card image cap">
                                </div>
                            </div>
